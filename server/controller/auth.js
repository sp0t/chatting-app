...
export const LoginUser = async (req, res) => {
    ...
    try {
        ...
        const finalData = {token , user : { name : checkUser.name , email : checkUser.email , _id : checkUser._id,  online  : true }}
...
export const RegisterUser = async (req, res) => {
    ...
    const { error } = registerSchemaValidation.validate( {name , email , password , confirmPassword} );

...
export const get_top_constributers = async () => {

    try {
        const res = await fetch(`http://localhost:8000/api/get_top_constributers`, {
            method: 'GET'
        });
        const data = await res.json();
        return data;
...
export const get_online_users = async () => {
    ...
    try {
        const res = await fetch(`http://localhost:8000/api/get_online_users`, {
            method: 'GET'
        });
        const data = await res.json();
        return data;
...
export const get_chart_week = async () => {

    try {
        const res = await fetch(`http://localhost:8000/api/get_chart_week`, {
            method: 'GET'
        });
        const data = await res.json();
        return data;
...
export const get_chart_day = async () => {

    try {
        const res = await fetch(`http://localhost:8000/api/get_chart_day`, {
            method: 'GET'
        });
        const data = await res.json();
        return data;
...
export const get_growth = async () => {

    try {
        const res = await fetch(`http://localhost:8000/api/get_growth`, {
            method: 'GET'
        });
        const data = await res.json();
        return data;
